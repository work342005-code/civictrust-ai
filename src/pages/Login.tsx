...
export default function Login() {
  ...
  const handleRegister = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setLoading(false);
      toast({ title: "Account created!", description: "Welcome to CivicLens AI." });
      navigate("/dashboard");
    }, 1000);
  };
              ...
              <form onSubmit={handleRegister} className="space-y-4">
                <div>
                  ...
                  <div className="relative mt-1.5">
                    ...
                    <Input id="name" placeholder="Your full name" className="pl-9" required />
                  </div>
                </div>
                <div>
                  ...
                  <div className="relative mt-1.5">
                    <Mail className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground" />
                    <Input id="reg-email" type="email" placeholder="you@example.com" className="pl-9" required />
                  </div>
                </div>
                <div>
                  ...
                  <div className="relative mt-1.5">
                    <Lock className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground" />
                    <Input id="reg-password" type="password" placeholder="••••••••" className="pl-9" required />
                  </div>
                </div>
                <Button type="submit" className="w-full gap-2" disabled={loading}>
